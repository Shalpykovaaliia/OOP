...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2018 at 04:05 PM
...
(13, 'black sheep : the awekening v2', '9789713003432', 'Available', 'asdasd', 'asdasd', 'asdasd', '1st', '2009', '2017-11-25', '2017-11-26'),
...
(55, 14, 3, NULL, '2018-02-19', '2018-02-17', NULL);
...
INSERT INTO `tbl_borrower` (`borrower_id`, `title`, `firstname`, `lastname`, `birthday`, `gender`, `address1`, `address2`, `address3`, `postal_code`, `town`, `country`, `mobile_number`, `email_address`) VALUES
(1, 'Mr', 'Kevin', 'Daus', '2017-11-22', 'MALE', 'asdasdasdasd', 'asd', NULL, 'sdasd', 'municipality', NULL, '09973470558', 'test@gmail.com'),
(2, 'Mrs', 'Janey', 'Dee', '2017-11-15', 'FEMALE', 'asd', 'asd', 'sdasd', 'asd', 'municipality', NULL, '07312654978', 'asdasd@gmail.com'),
(3, 'Mrs', 'Janey', 'Tester1', '2017-12-13', 'FEMALE', 'Street1', 'Barangay1', NULL, '3709', 'Solano', NULL, '09973470558', 'tester@gmail.com');
...
(10, 54, 'SENT', '2018-02-17 22:59:54');
...
--
ALTER TABLE `tbl_book_borrower`
  ADD CONSTRAINT `tbl_book_borrower_ibfk_1` FOREIGN KEY (`borrower_id`) REFERENCES `tbl_borrower` (`borrower_id`);
